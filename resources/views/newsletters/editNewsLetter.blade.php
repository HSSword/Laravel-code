        ...
        <div class="main-panel">
            <div class="content">    
                <div class="container-fluid" style='margin-left:10px'>
                    ...
                    <div class='row'>
                        <div class='col-md-6'>
                            <img src="https://www.meinweekend.ch/{{$d->offer_1_pic}}" alt="meinweekend" width='250px' height='auto'>
                        </div>
                        <div class='col-md-6'>
                            <img src="https://www.meinweekend.ch/{{$d->offer_2_pic}}" alt="meinweekend" width='250px' height='auto'>
                        </div>
