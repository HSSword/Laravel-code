                            ...
                            <div class="card tabbsSteps">
                                @foreach($offer as $d)
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        @endphp --}}
                                        <li class="active show"><a data-toggle="tab" href="#home" class="btn btn-info home" role="button" onClick="saveTab('home')">General</a></li>
                                        <li><a data-toggle="tab" href="#menu1" class="btn btn-info menu1" role="button" onClick="saveTab('menu1')">Related Offers</a></li>
                                        <li><a data-toggle="tab" href="#menu2" class="btn btn-info menu2" role="button" onClick="saveTab('menu2')">Images</a></li>
                                        <li><a data-toggle="tab" href="#menu3" class="btn btn-info menu3" role="button" onClick="saveTab('menu3')">Categories & Regions</a></li>
                                        <li><a data-toggle="tab" href="#menu4" class="btn btn-info menu4" role="button" onClick="saveTab('menu4')">Terms of payment</a></li>
                                        <li><a data-toggle="tab" href="#menu5" class="btn btn-info menu5" role="button" onClick="saveTab('menu5')">Package</a></li>
                                        <li><a data-toggle="tab" href="#menu6" class="btn btn-info menu6" role="button" onClick="saveTab('menu6')">Expanded Options</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        ...
                                        <div id="menu5" class="tab-pane fade">
                                            ...
                                            <div class='row'>
                                                ...
                                                <table class='table'>
                                                    <tr><th>Price title</th><th>Option</th><th>adult price</th><th>Hidden</th><th>*</th><th>*</th><th>*</th></tr>
                                                    @foreach($prices as $p)
                                                        <tr id={{$p->uid}}>    
                                                            <td>{{$p->title}}</td>
                                                            <td>{{$p->otitle}}</td>
